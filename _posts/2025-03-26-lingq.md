...
also where I learned about many more Dutch language content creators I did not know. In addition, the audio contents are categorized under different subjects, for example, history,
entertainment, culture, travel, technology, health, news, etc. This helps you expose yourself to vocabularies in different areas that you otherwise might not step into.

In addition, one feature I liked a lot with the free version is it let you import audio/video contents you're interested in from many different sources into LingQ. That means
I could import YouTube videos into LingQ and use LingQ to manage all the contents that I have learned before. However, the free versoin only allows you import limited number
of videos. In the free version, I also got a sneak peek into the features like **quizzes** and **saving words and phrases for review** which are part of the built-in '[**Spaced
Repetition Software**][srs]'.

All in all, I had good impression about LingQ. TODO: explain.
